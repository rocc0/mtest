...
urlpatterns = [
    ...
    url(r'^d/(?P<pk>[\w-]+)$', views.mtest_edit, name='mtest_edit'),
    url(r'^d/(?P<pk>[\w-]+)/get/$', serializers.mtest_get, name='mtest_json'),
    url(r'^d/(?P<pk>[\w-]+)/pdf/$', views.to_pdf, name='to_pdf'),
    url(r'^e/(?P<pk>[\w-]+)$', views.mtest_edit, name='mtest_edit'),
    url(r'^e/(?P<pk>[\w-]+)/get/$', serializers.mtest_get, name='mtest_json'),
    url(r'^e/(?P<pk>[\w-]+)/pdf/$', views.to_pdf, name='to_pdf'),
